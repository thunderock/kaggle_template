...
snakemake: clean_snakemake
	...
	@poetry run snakemake all --cores $(CORES) --config base_input_path=$(INPUT_PATH) base_data_path=$(DATA_PATH) base_script_path=$(SCRIPT_PATH) --nolock --ignore-incomplete -n
